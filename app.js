...
function rtveVideoButton(match) {
  ...
  return `<a class="video-link" href="${escapeHtml(video.url)}" target="_blank" rel="noopener noreferrer" title="${escapeHtml(video.title || 'Resumen RTVE')}">
    <span>▶</span>
    <strong>Resumen RTVE</strong>
  </a>`;
}
